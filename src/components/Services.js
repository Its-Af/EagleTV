                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="centerText lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            <div className='text-blue-900 mb-4' style={{justifyContent:"center", display:"flex"}}>
                        ...
                        <div className="centerText lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <h3 className="text-3xl  text-blue-900 font-bold">Readily <span className='font-black'>Available</span></h3>
                            <div>
