        ...
        <nav className={`mt-19 sm:mt-15 fixed top-0 w-full z-30 transition duration-300 ease-in-out mb-16 ${!top && 'bg-white shadow-lg'}`}>
            <div className="flex flex-row justify-between items-center py-2" style={{height:"75px"}}>
                <div className="flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold">
                    <HashLink smooth to="/#hero"><img alt="Company Logo" src={companyLogo} className="navLogo font-extrabold text-4xl text-blue-600"></img></HashLink>
                    
                </div>
                <div className="group flex flex-col items-center">
                    <button className="p-2 rounded-lg lg:hidden text-blue-600" onClick={handleClick} style={{ position: 'absolute', right: '10px', top: '20px' }}>
